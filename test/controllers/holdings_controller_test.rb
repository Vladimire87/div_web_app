...
class HoldingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create holding' do
    assert_difference('Holding.count') do
      post holdings_url,
           params: { holding: { portfolio_id: @holding.portfolio_id, shares: @holding.shares,
  ...
  test 'should update holding' do
    patch holding_url(@holding),
          params: { holding: { portfolio_id: @holding.portfolio_id, shares: @holding.shares, ticker: @holding.ticker } }
